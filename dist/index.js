...
const promise_1 = __importDefault(__nccwpck_require__(575));
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield (0, promise_1.default)(`https://${pat}@github.com/thingsup/thingsup-tracking-frontend.git`, './tmp/frontend');
            ...
            {
                const { stderr } = yield exec('npm i pkg -g');
                if (stderr) {
            ...
            {
                const { stderr } = yield exec(`cd ./tmp/backend && pkg --compress GZip --out-path ./${distFolderName} .`);
                if (stderr) {
...
const impl = __nccwpck_require__(596);
